...
public class StudentHomeworkInfoService implements StudentHomeworkInfoManager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("StudentHomeworkInfoMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("StudentHomeworkInfoMapper.listAll", pd);
	}
