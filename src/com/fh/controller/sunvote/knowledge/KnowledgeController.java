package com.fh.controller.sunvote.knowledge;
...
public class KnowledgeController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("KNOWLEDGE_ID", this.get32UUID());	//主键
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Knowledge");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Knowledge");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Knowledge");
		...
		mv.setViewName("sunvote/knowledge/knowledge_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("sunvote/knowledge/knowledge_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("P_ID"));	    //2
			vpd.put("var3", varOList.get(i).get("RANK").toString());	//3
