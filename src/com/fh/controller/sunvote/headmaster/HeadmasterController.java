...
public class HeadmasterController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = headmasterService.listAll(pd);
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var4", varOList.get(i).getString("SCHOOL_ID"));	    //4
			vpd.put("var5", varOList.get(i).getString("PERMISSION"));	    //5
