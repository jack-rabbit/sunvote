package com.fh.controller.sunvote.testpaper;
...
public class TestPaperController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("sunvote/testpaper/testpaper_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("sunvote/testpaper/testpaper_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("PAPER_ID"));	    //2
			vpd.put("var3", varOList.get(i).getString("SCLASS_ID"));	    //3
			vpd.put("var4", varOList.get(i).getString("TEACHER_ID"));	    //4
			vpd.put("var5", varOList.get(i).getString("START_DATE"));	    //5
			vpd.put("var6", varOList.get(i).getString("END_DATE"));	    //6
			vpd.put("var7", varOList.get(i).getString("CREATE_DATE"));	    //7
			vpd.put("var8", varOList.get(i).get("OTHER_SCORE").toString());	//8
			vpd.put("var9", varOList.get(i).get("HIGHT_SCORE").toString());	//9
			vpd.put("var10", varOList.get(i).get("LOW_SCORE").toString());	//10
			vpd.put("var11", varOList.get(i).get("AVG_SCORE").toString());	//11
