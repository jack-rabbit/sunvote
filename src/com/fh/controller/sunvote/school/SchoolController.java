...
public class SchoolController extends BaseController {
	...
	String menuUrl = "school/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增学校");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除学校");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "del")){return;} //校验权限
		PageData pd = new PageData();
		pd = this.getPageData();
		FHLOG.save(getUsername(), "删除学校:" + pd.getString("NAME"));
	...
	public ModelAndView edit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		FHLOG.save(getUsername(), "修改学校:" + pd.getString("NAME"));
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除学校");
		FHLOG.save(getUsername(), "批量删除学校");
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			schoolService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出School到excel");
		...
		List<PageData> varOList = schoolService.listAll(pd);
