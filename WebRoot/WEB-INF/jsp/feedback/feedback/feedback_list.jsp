...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">学校地址省</th>
									<th class="center">学校地址市</th>
									<th class="center">联系人</th>
									<th class="center">联系电话</th>
									<th class="center">产品序列号</th>
									<th class="center">问题现象</th>
									<th class="center">操作系统</th>
									<th class="center">软件版本</th>
									<th class="center">软件名称</th>
									<th class="center">异常数量</th>
									<th class="center">详细描述</th>
									<th class="center">问题图片</th>
									<th class="center">客户编码</th>
									<th class="center">处理人</th>
									<th class="center">报告日期</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.SCHOOL_ADDRESS1}</td>
											<td class='center'>${var.SCHOOL_ADDRESS2}</td>
											<td class='center'>${var.CONTACT_PHONE}</td>
											<td class='center'>${var.PHONE_CONTACT}</td>
											<td class='center'>${var.PRODUCT_SEQ}</td>
											<td class='center'>${var.QUESTION_NAME}</td>
											<td class='center'>${var.OS}</td>
											<td class='center'>${var.SOFTWARE_VERSION}</td>
											<td class='center'>${var.SOFTWARE_NAME}</td>
											...
											<td class='center'>${var.PROCESSING_DATE}</td>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>feedback/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 355;
