	...
	<form action="../paper/list2.do" method="post" name="Form" id="Form">
		...
		<div class="box_header">
			...
			<div class="head_box_r">
				<input class="date-picker" type="text" placeholder="Start Date" name="lastStart" id="lastStart" data-date-format="yyyy-mm-dd" readonly="readonly" value="${pd.LASTSTART }"/> 
				<input type="text" class="date-picker" placeholder="End Date" name="lastEnd" name="lastEnd" data-date-format="yyyy-mm-dd" readonly="readonly" value="${pd.LASTEND}"/>
			...
			<div style="padding:0 5%;background:#fff;">
				...
				<thead>
					<tr>
						<th><input type="checkbox"  name='ids' id="ids" />Serial No.</th>
		...
		<div class="table_box">
			...
			<div class="footer" style="margin-top:50px">
				<div class="creat">
					<input type="button"  onclick="parent.$('.title_time').modal('show');" value="New Paper" />
				</div>
				<div class="removeAll">
