			...
			<div class="page-content">
				<div class="row">
					...
					<form action="teacher/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="SEAT_PHONE" id="SEAT_PHONE" value="${pd.SEAT_PHONE}" maxlength="255" placeholder="这里输入座机电话" title="座机电话" style="width:98%;"/>
						<input type="hidden" name="CARD_NO" id="CARD_NO" value="${pd.CARD_NO}" maxlength="255" placeholder="这里输入证件号" title="证件号" style="width:98%;"/>
