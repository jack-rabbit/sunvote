...
<html lang="zh-CN">
  ...
  <body>
	  ...
	  <div class="head_box">
		...
		<div class="table_box"  style="margin-top:30px">
			<table class="table table-striped">
				<col style="width: 10%" />
				<col style="width: 20%" />
				<col style="width: 10%" />
			...
			<div class="footer"  style="margin-top:50px">
				<div class="creat">
					<input type="button"  id="creatPaper" value="New Paper " />
				</div>
				<div class="removeAll">
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<h4 class="modal-title">Please select class</h4>
			  </div>
			  ...
			  <div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="submit" onclick="setQUestion()">Ok</button>
			  </div>
			</div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
		</div><!-- /.modal -->
