	  ...
	  <div class="header_box  container">
		...
		<div class="btn_group">
			...
			<div class="btn_box pull-right">
				<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".fast" id="fast">添加</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">题型</label>
		    <div class="col-sm-10">
		...
		<div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">题目数</label>
		    <div class="col-sm-10">
		      <input type="number" class="form-control" id="number" placeholder="输入题目数量" maxlength="119">
...
<script type="text/javascript" src="../static/js/control-604.js?a=3"></script>
